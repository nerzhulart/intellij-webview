...
internal class WebViewConsoleCaptureTest {
  ...
  fun loggerCategoryContainsViewIdOnlyWhenPresent() {
    ...
    assertEquals("#io.github.nerzhulart.webview.console.main_view_42", capture.loggerCategory())
    capture.setViewId(null)
    assertEquals("#io.github.nerzhulart.webview.console", capture.loggerCategory())
  }
