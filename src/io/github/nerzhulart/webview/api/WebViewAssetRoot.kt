...
class WebViewAssetRoot private constructor(
  ...
  companion object {
     ...
     * the WebView UI Authoring Guide).
     *
     ...
     *
     * Loads assets from [owner]'s classloader. From Kotlin, prefer the no-class `forView(viewId)` overload.
     *
     * [viewsRoot] is the classpath prefix under which views live; it defaults to `webview/views`.
     */
    @JvmStatic
     ...
     *
     * [devSourceRoot] is an optional development-only asset directory matching [root]. When set, files from this directory
     * override packaged classpath resources during test and development runs.
     */
    @JvmStatic
    @JvmOverloads
